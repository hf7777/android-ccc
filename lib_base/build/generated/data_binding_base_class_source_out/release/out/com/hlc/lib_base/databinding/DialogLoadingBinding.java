...
package com.hlc.lib_base.databinding;
...
public final class DialogLoadingBinding implements ViewBinding {
  ...
  private DialogLoadingBinding(@NonNull LinearLayout rootView, @NonNull TextView tvLoadingMessage) {
  ...
  public static DialogLoadingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new DialogLoadingBinding((LinearLayout) rootView, tvLoadingMessage);
    }
